{{ $workbox := resources.Get "js/workbox-sw.js" | resources.Fingerprint }}
<script defer src="{{ $workbox.RelPermalink }}"></script>
...
! function() {
    ...
    self.workbox = new class {
        ...
        i(t) {
            ...
            let e = ["https://cdn.jsdelivr.net/npm/workbox-cdn@5.1.2/workbox"];
            const s = `${t}.${this.s}.js`,
